    ...
    <div className="flex flex-1 gap-6">
      ...
      <div className="hidden lg:block w-80 p-4">
        <div className="bg-white rounded-lg border shadow-sm p-6">
          <h3 className="text-lg font-semibold mb-6 text-gray-900">Legend</h3>
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-4 h-4 bg-blue-600 rounded"></div>
              <span className="text-sm text-gray-700">School Closed</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-4 h-4 bg-purple-400 rounded"></div>
              <span className="text-sm text-gray-700">Early Release</span>
            </div>
            <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-gray-700">NYS Exams</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-4 h-4 bg-orange-400 rounded"></div>
              <span className="text-sm text-gray-700">Quarter Exams</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-4 h-4 bg-green-400 rounded"></div>
              <span className="text-sm text-gray-700">No Busing</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-4 h-4 bg-blue-200 rounded"></div>
              <span className="text-sm text-gray-700">Staff Development (no school for students)</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-4 h-4 bg-gray-300 rounded"></div>
              <span className="text-sm text-gray-700">Parent Teacher Conferences / No Classes</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-4 h-4 border-2 border-green-500 bg-white rounded"></div>
              <span className="text-sm text-gray-700">First & Last Day of School</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-4 h-4 border-2 border-red-500 bg-white rounded"></div>
              <span className="text-sm text-gray-700">Quarter End</span>
            </div>
          </div>
