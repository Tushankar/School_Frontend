        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          >
            <div className="flex items-center gap-6 mb-6">
              ...
              <div>
                <h1 className="text-2xl font-bold mb-1">AL-RASHEED ACADEMY</h1>
            ...
            <div className="max-w-3xl">
              ...
              <p className="text-lg text-gray-100 leading-relaxed">
                Creating unity, responsibility, and a positive learning
                environment through proper attire. Your cooperation ensures our
                students are prepared for success every day.
              </p>
            </div>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            ...
            >
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="font-bold text-lg text-gray-800">Gym Days</h3>
              </div>
              <p className="text-gray-600 text-sm">
            ...
            >
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="font-bold text-lg text-gray-800">Compliance</h3>
              </div>
              <p className="text-gray-600 text-sm">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-[#201f1a] mb-3">
                  Dress Code Violations Policy
                </h3>
                <div className="space-y-3 text-gray-700">
                  <p>
                    <strong>Parent Responsibility:</strong> Parents are
                    responsible for ensuring their child leaves home in full
                    uniform each day.
                  </p>
                  <p>
                    <strong>School Entry:</strong> Students must enter school
                    premises fully uniformed. Students not in proper uniform
                    will not be admitted.
                  </p>
                  <p>
                    <strong>Consequences:</strong> If a student arrives without
                    proper uniform, parents must bring the uniform or the
                    student will receive after-school detention.
                  </p>
                  <p>
                    <strong>Repeated Violations:</strong> Continued violations
                    will result in suspension until a parent conference is held.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="mb-8 grid md:grid-cols-2 gap-6">
                  <div className="bg-blue-50 rounded-lg p-6 border-l-4 border-blue-500">
                    ...
                    <p className="text-gray-700 text-sm">
                      Every student must wear the required daily uniform every
                      day. Both boys and girls may wear uniform sweaters or
                      fleece jackets/vests as optional layers.
                    </p>
                  </div>
                  ...
                  <div className="bg-yellow-50 rounded-lg p-6 border-l-4 border-yellow-500">
                    ...
                    <p className="text-gray-700 text-sm">
                      Gym uniforms are worn <strong>ONLY</strong> on gym, games,
                      and field trip days. Girls 4th grade and up may wear gym
                      uniforms under their abayas.
                    </p>
                  </div>
                </div>
                        ...
                        <ul className="space-y-3">
                          <li className="flex items-start gap-3">
                            ...
                            <span className="text-gray-700">
                              <strong>Navy Blue uniform dresses</strong> with
                              Navy Blue pants
                            </span>
                          </li>
                          <li className="flex items-start gap-3">
                      ...
                      <div>
                        <ul className="space-y-3">
                          ...
                          <li className="flex items-start gap-3">
                            <CheckCircle2 className="h-5 w-5 text-purple-600 mt-0.5 flex-shrink-0" />
                            <span className="text-gray-700">
                              <strong>Black Cardigans/Button down</strong> (no
                              zippers or hoods allowed)
                            </span>
                          </li>
                        </ul>
                      </div>
                      ...
                      <div>
                        <ul className="space-y-3">
                          <li className="flex items-start gap-3">
                            ...
                            <span className="text-gray-700">
                              <strong>School uniform colors</strong> by school
                              level
                            </span>
                          </li>
                          <li className="flex items-start gap-3">
              ...
              >
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-600 max-w-2xl mx-auto">
                    Appropriate athletic wear for gym class, games, and outdoor
                    activities
                  </p>
                </div>
                  ...
                  <div className="bg-pink-50 rounded-lg p-4 border-2 border-pink-200">
                    ...
                    <ul className="space-y-2">
                      <li className="flex items-start gap-2">
                        ...
                        <span className="text-gray-700 text-sm">
                          <strong>Long sleeve t-shirt</strong> (no design)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="h-4 w-4 text-pink-600 mt-0.5 flex-shrink-0" />
          ...
          >
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-gray-100 mb-8 text-lg">
                Our office staff is available to answer any questions about
              ...
              <div className="flex flex-wrap justify-center gap-6">
                ...
                >
                  ...
                  <span>(716) 706-1303</span>
                </a>
                <a
                  href="mailto:registration@alrasheed.edu"
                ...
                >
                  ...
                  <span>registration@alrasheed.edu</span>
                </a>
              </div>
            </div>
          </motion.div>
